...
class UpsideDownThirdIllusionFragment: BaseFragment<UpsideDownVM>(){

    override val viewModel by sharedViewModel<UpsideDownVM>()
    override fun getLayoutResources() = R.layout.fragment_upside_down_third_illusion
    ...
    private fun configureObservers() {
        viewModel.thirdIllusioAnser.observe(viewLifecycleOwner, Observer {
            it.apply {
    ...
    private fun initListeners() {
        btnSaveAnswers.setOnClickListener {
            if(etChildAnswer.text.isEmpty() || etMentorAnswer.text.isEmpty()){
                ...
                viewModel.saveAnswers(ILLUSION_PLAYER_WOMENA, etChildAnswer.text.toString(), etMentorAnswer.text.toString())
                        .doOnComplete {
                            btnSaveAnswers.toInvisible()
