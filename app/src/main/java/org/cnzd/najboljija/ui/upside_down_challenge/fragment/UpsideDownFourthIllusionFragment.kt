...
class UpsideDownFourthIllusionFragment: BaseFragment<UpsideDownVM>(){


    override val viewModel by sharedViewModel<UpsideDownVM>()
    override fun getLayoutResources() = R.layout.fragment_upside_down_fourth_illusion
    ...
    private fun configureObservers() {
        viewModel.fourthIllusionAnswer.observe(viewLifecycleOwner, Observer {
            it.apply {
    ...
    private fun initListeners() {
        btnSaveAnswers.setOnClickListener {
            if(etChildAnswer.text.isEmpty() || etMentorAnswer.text.isEmpty()){
                ...
                viewModel.saveAnswers(ILLUSION_DUCK_RABBIT, etChildAnswer.text.toString(), etMentorAnswer.text.toString())
                        .doOnComplete {
                            btnSaveAnswers.toInvisible()
